...
module.exports = {
    ...
    title_text: {
        features: "Feature requests for " + organization,
        product_list: "Products list of " + organization,
        reports: "Feature Reports"
    },
    modal: {
        feature_request: {
            title: "Suggest a feature for " + organization,
            feature: {
            ...
            btn_suggest: "Tell " +organization+" I want this"
        },
        status_update: {
            title: "Update Status",
            subject: {
    ...
    button: {
        suggest_feature: "Suggest a feature for " + organization,
    ...
    copyright: "&copy; 2010-2016 " + organization + " Inc. All Rights Reserved."
};