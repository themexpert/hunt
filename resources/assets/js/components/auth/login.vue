            ...
            <div class="container">
                <div class="feature-req">
                    <div class="center-align feature-form-area">
                        <h2 class="feature-req-title">Login</h2>
                    </div>
                </div><!--/.feature-req-->
            </div>
        </div><!--/.banner-->
            ...
            <div class="login">
                <div class="row">
                    <div class="col s6 offset-s3">
                            ...
                            <div class="login-section card-content">
                                ...
                                <form action="">
                                    <div class="input-field">
                                        <input id="lemail" v-model="email" type="email" class="validate" placeholder="Your Email">
                                        <label for="lemail">Email</label>
                                    </div><!--/.input-field-->

                                    <div class="input-field">
                                        <input id="lpassword" v-model="password" type="password" class="validate" placeholder="Password">
                                    ...
                                    <div class="input-field">
                                        ...
                                        <a class="btn btn-block" @click="login" :disabled="busy">Log In <spinner v-if="busy"></spinner></a>
                        ...
                        <div class="singup">
                            <div class="right-align">Don’t have an account? <router-link class="waves-effect waves-light btn red" to="/register">Sign Up</router-link></div>
                        </div>
                    </div><!--/.col-->
                </div>
            </div><!--/.feature-req-->
