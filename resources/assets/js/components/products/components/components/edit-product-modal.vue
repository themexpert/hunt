                ...
                <form class="" action="" @submit.prevent="updateProduct">
                    <div class="row">
                        <div class="input-field">
                            <input name="name" v-model="n_product.name" id="product_name" type="text" :placeholder="lang.modal.new_product.product.placeholder">
                            <label for="product_name" v-text="lang.modal.new_product.product.title">Product Name</label>
                        </div>
                    </div><!--/.row-->
                    <div class="input-field">
                        <textarea name="description" v-model="n_product.description" id="textarea1" class="materialize-textarea" :placeholder="lang.modal.new_product.description.placeholder"></textarea>
